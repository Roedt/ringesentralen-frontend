...
describe('tester funksjonen lageEnumvennligStreng', () => {
  ...
  test('funksjonen bytter ut .', () => {
    const ord = lageEnumvennligStreng('Reversering av tvangssammenslåtte fylker og kommuner．')
    expect(ord).toBe('Reverseringavtvangssammenslaattefylkerogkommuner')
  })

  test('funksjonen fjerner .', () => {
    const ord = lageEnumvennligStreng('a.b.c,d')
    expect(ord).toBe('a_b_c_d')
  })
