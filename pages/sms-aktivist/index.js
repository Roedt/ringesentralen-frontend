...
import SMSSkjema from './skjema'

function SMSAktivist () {
  const [success, setSuccess] = useState()

  return (
    <>
      <Head>
        <title>Meld deg som SMS-aktivist for Rødt</title>
      </Head>
          ...
          <header className='bg-roedt py-16 px-4 sm:px-6 lg:col-span-2 lg:px-8 lg:py-24 xl:pr-12'>
            <div className='max-w-lg mx-auto'>
              ...
              <p className='mt-3 text-lg leading-6 text-white'>
                Har du lyst til å bli SMS-aktivist for Rødt?
              </p>
              <p className='mt-3 text-lg leading-6 text-white'>
                Fyll ut skjemaet, så blir du det!
              </p>
              <p className='mt-6 text-lg text-white'>
                Vil du bidra til tidenes valgkamp for Rødt?<br /><a href='https://www.rødt.no/bidra' className='text-white underline'>Les mer på rødt.no/bidra</a>.
              </p>
            </div>
          </header>
