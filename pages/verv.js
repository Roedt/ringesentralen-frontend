        ...
        <div className='roedt py-16 px-4 sm:px-6 lg:col-span-2 lg:px-8 lg:py-24 xl:pr-12'>
          <div className='max-w-lg mx-auto'>
            ...
            <p className='mt-6 text-base text-white'>
              Vil du bidra til tidenes valgkamp for Rødt? <a href='https://www.fellesskapfungerer.no/' className='font-medium text-white underline'>Les mer på fellesskapfungerer.no</a>.
            </p>
          </div>
        </div>
