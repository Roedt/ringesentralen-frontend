function Hjelp () {
  return (
    <div className='rounded-xl bg-gray-100 p-8 md:p-8'>
      ...
      <p className='mt-4'>Når det er gjort er du registrert, og du kan logge inn her på Ringesentralen.</p>
      ...
      <p className='mt-4'>Viss du ikkje får tilgang da, logg ut og inn igjen.</p>
